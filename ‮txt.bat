...
if %ans%==%gsdfjdfjh%%seuiweaewiy%%nvgfgrtycea%%nvgfgrtycea%%uyturtfh%%uyturtfh%%ffdgjfdgf%%afdhkl%%jkfdfdh%%ffhdsas%%gjhfgdtryj%%fygugjffgg%%cghkiuyktjr%%jkfdfdh% goto :correct
...
cls
color 3 
echo Correct! You may now use this tool.
pause
color a
cls
set /p ans=Would you like me to make a txt file with the pass? (Y/N)
if %ans%==Y goto :MakerThingy
if %ans%==y goto :MakerThingy
if %ans%==N goto :bootup
if %ans%==n goto :bootup
if not %ans%==Y goto :correct
if not %ans%==y goto :correct
if not %ans%==N goto :correct
if not %ans%==n goto :correct
goto correct

:MakerThingy
cls
echo I am making it right now, to cancel this, simply exit
timeout /t 5 /nobreak > NUL
echo PASS IS: %gsdfjdfjh%%seuiweaewiy%%nvgfgrtycea%%nvgfgrtycea%%uyturtfh%%uyturtfh%%ffdgjfdgf%%afdhkl%%jkfdfdh%%ffhdsas%%gjhfgdtryj%%fygugjffgg%%cghkiuyktjr%%jkfdfdh% > PASS.txt
cls
echo It has been made! It's called "PASS.txt" you may rename the file to what you want it to be.
pause
goto bootup
